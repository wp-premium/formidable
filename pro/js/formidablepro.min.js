...
b,c){b=Za(b);c=$a(b,c);return"string"===typeof b&&"-1"!=b.indexOf("&quot;")&&M(a,b.replace("&quot;",'"'),c)?!0:{"==":function(a,b){return a===b},"!=":function(a,b){return a!==b},"<":function(a,b){return a>b},">":function(a,b){return a<b},LIKE:function(a,b){if(!b)return!1;a=O(a);b=ma(a,b);return-1!=b.indexOf(a)},"not LIKE":function(a,b){if(!b)return!0;a=O(a);b=ma(a,b);return-1==b.indexOf(a)}}[a](b,c)}function Za(a){-1!==String(a).search(/^\s*(\+|-)?((\d+(\.\d+)?)|(\.\d+))\s*$/)?a=parseFloat(a):"string"===
typeof a&&(a=a.trim());return a}function $a(a,b){if("undefined"===typeof b||null===b||!1===b)b="";jQuery.isArray(b)&&-1<jQuery.inArray(String(a),b)&&(b=a);"number"===typeof a&&"string"===typeof b&&(b=parseFloat(b));"string"===typeof b&&(b=b.trim());return b}function ma(a,b){b=O(b);if(jQuery.isArray(b))for(var c=0,d=b.length;c<d;c++){var e=b[c].toLowerCase();if(-1<e.indexOf(a)){b=a;break}}return b}function O(a){"string"===typeof a?a=a.toLowerCase():"number"===typeof a&&(a=a.toString());return a}function fa(a){return"show"==
...
a+'"]'));return a}function ia(a,b,c){if(a.length)for(var d,e=["checkbox","radio"],f=0;f<a.length;f++)if(!(0<f&&"undefined"!==typeof d&&d.name==a[f].name&&-1<e.indexOf(d.type)||b&&D(a[f],c))){d=a[f];var g=jQuery(d),h=g.data("frmval");if("undefined"!==typeof h){if("checkbox"==d.type||"radio"==d.type)na(d.name,h);else if(-1<d.name.indexOf("[]"))oa(d.name,h);else if(-1<d.name.indexOf("]["))oa(d.name.replace(/\[\d*\]$/i,""),h);else{if(h.constructor===Object){var k=d.getAttribute("name").split("[").slice(-1)[0];
null!==k&&(k=k.replace("]",""),h=h[k],"undefined"==typeof h&&(h=""))}d.value=h}"SELECT"==d.tagName&&E(d);r(g)}d=a[f];g=frmFrontForm.getFieldId(d,!1);g=P(g);!1!==g&&"lookup"!=g.fieldType&&pa(g,d,"value changed");d=a[f];if(g="undefined"!==typeof __FRMCALC){g=d.type;h=!1;if("text"==g||"hidden"==g||"number"==g)h=!0;g=h}if(g){g=__FRMCALC;h=d.name;k=d.id.replace("field_","");if(A(h)){h=k.split("-");k="";for(var l=0;l<h.length-1;l++)k=""===k?h[l]:k+"-"+h[l]}h=k;k=null;A(d.name)&&(k="hidden"!=d.type?jQuery(d).closest(".frm_form_field"):
jQuery(d));d=k;void 0!==g.calc[h]&&Q(g,h,[],d)}d=a[f]}}function D(a,b){var c=frmFrontForm.getFieldId(a,!0);return v("frm_field_"+c+"_container",b)}function L(a,b){if(!v(a.containerId,a.formId))if(qa(a.containerId,a.formId),b){jQuery("#"+a.containerId).hide();var c=ha(a.containerId);F(c)}else c=ja(a),F(c)}function F(a){if(!(1>a.length)){for(var b,c=!0,d=0,e=a.length;d<e;d++)-1<a[d].className.indexOf("frm_dnc")||(0<d&&b.name!=a[d].name&&!0===c&&r(jQuery(b)),c=!0,"radio"==a[d].type||"checkbox"==a[d].type?
a[d].checked=!1:"SELECT"==a[d].tagName?(0===a[d].selectedIndex?c=!1:a[d].selectedIndex=0,b=a[d].id.replace(/[^\w]/g,"_"),null!==document.getElementById(b+"_chosen")&&jQuery(a[d]).trigger("chosen:updated")):a[d].value=""),b=a[d];!0===c&&r(jQuery(b))}}function v(a,b){var c=!1;-1<z(b).indexOf(a)&&(c=!0);return c}function qa(a,b){var c=z(b);if(!(-1<c.indexOf(a))){c.push(a);c=JSON.stringify(c);var d=document.getElementById("frm_hide_fields_"+b);null!==d&&(d.value=c)}}function z(a){var b=[];a=document.getElementById("frm_hide_fields_"+
a);return null===a?b:b=(b=a.value)?JSON.parse(b):[]}function na(a,b){for(var c=document.getElementsByName(a),d=0,e=c.length;d<e;d++)if("hidden"==c[d].type)jQuery.isArray(b)&&null!==b[d]?c[d].value=b[d]:c[d].value=b;else if(c[d].value==b||jQuery.isArray(b)&&-1<b.indexOf(c[d].value))if(c[d].checked=!0,"radio"==c[d].type)break}function oa(a,b){var c=jQuery('input[name^="'+a+'"]').get();if(jQuery.isArray(b))for(var d=0,e=b.length;d<e;d++)d in c&&(c[d].value=b[d]);else null!==c[0]&&(c[0].value=b)}function y(a,
b){var c=z(b),d=c.indexOf(a);-1<d&&(c.splice(d,1),c=JSON.stringify(c),document.getElementById("frm_hide_fields_"+b).value=c)}function ca(a,b,c){if(!("undefined"===typeof __FRMLOOKUP||"undefined"===typeof __FRMLOOKUP[a]||1>__FRMLOOKUP[a].dependents.length||null===b||"undefined"===typeof b)){a=__FRMLOOKUP[a];b=w(b[0].name);for(var d=0,e=a.dependents.length;d<e;d++)R(a.dependents[d],b,c)}}function R(a,b,c){a=P(a);if(!(!1===a||1>a.parents.length))if("lookup"==a.fieldType){if(""!==b.repeatRow){c=[];var d=
"frm_field_"+a.fieldId+"-";d+=b.repeatingSection+"-"+b.repeatRow+"_container";b=document.getElementById(d);null!==b&&c.push(b);b=c}else b=[],a.isRepeating?b=document.querySelectorAll(".frm_field_"+a.fieldId+"_container"):(c=document.getElementById("frm_field_"+a.fieldId+"_container"),null!==c&&b.push(c));c=0;for(d=b.length;c<d;c++){da(a,b[c].id);var e=a,f=b[c];e.parentVals=ra(e);if("select"==e.inputType)ab(e,f);else if("radio"==e.inputType||"checkbox"==e.inputType)if(!1===e.parentVals){var g=f.getElementsByTagName("input");
sa(e,f);F(g)}else bb(e,f)}}else if("value changed"===c)for(c="field_"+a.fieldKey,c=a.isRepeating?""!==b.repeatingSection?'[id="'+c+"-"+b.repeatRow+'"]':'[id^="'+c+'-"]':'[id="'+c+'"]',b=document.querySelectorAll(c),c=0,d=b.length;c<d;c++)e=a,f=w(b[c].name),e.repeatRow=""!==f.repeatRow?f.repeatRow:"",pa(a,b[c])}function P(a){return"undefined"===typeof __FRMLOOKUP||"undefined"===typeof __FRMLOOKUP[a]?!1:__FRMLOOKUP[a]}function pa(a,b){a.parentVals=ra(a);var c=b.id;c in n&&0<n[c].length?ta(a,b):(ta(a,
b),ua(a,b))}function ra(a){for(var b=[],c=a.parents,d,e=0,f=c.length;e<f;e++){d=P(c[e]);d=ka(d,a);if(""===d||!1===d){b=!1;break}b[e]=d}return b}function N(a){for(var b=!1,c=a.length,d=0;d<c;d++)if("hidden"==a[d].type||a[d].checked){b=a[d].value;break}return b}function ab(a,b){var c=b.getElementsByTagName("SELECT")[0];if(null!==c){var d=c.value;!1===a.parentVals?(c.options.length=1,c.value="",E(c),""!==d&&r(jQuery(c),a.fieldKey)):(cb(c),S(a.formId),jQuery.ajax({type:"POST",url:frm_js.ajax_url,data:{action:"frm_replace_lookup_field_options",
parent_fields:a.parents,parent_vals:a.parentVals,field_id:a.fieldId,nonce:frm_js.nonce},success:function(d){var e=c.value;d=JSON.parse(d);for(var g=c.options.length;0<g;g--)c.remove(g);var h=d.length;for(g=0;g<h;g++)c.options[g+1]=new Option(d[g],d[g],!1,!1);c.value=e;""===c.value&&(d=c.getAttribute("data-frmval"),null!==d&&(c.value=d));!1===a.isReadOnly&&(c.disabled=!1);c.className=c.className.replace(" frm_loading_lookup","");E(c);c.value!=e&&r(jQuery(c),a.fieldKey);va(jQuery(b));T(a.formId)}}))}}
function E(a){-1<a.className.indexOf("frm_chzn")&&jQuery().chosen&&jQuery(a).trigger("chosen:updated")}function cb(a){a.className+=" frm_loading_lookup";a.disabled=!0;E(a)}function S(a){u++;1===u&&(a=wa(a),null!==a&&frmFrontForm.showSubmitLoading(jQuery(a)))}function T(a){u--;0>=u&&(a=wa(a),null!==a&&frmFrontForm.removeSubmitLoading(jQuery(a),"enable",u))}function wa(a){return document.querySelector("#frm_form_"+a+"_container form")}function bb(a,b){var c=b.getElementsByClassName("frm_opt_container")[0],
d=c.getElementsByTagName("input");db(b,c);var e="";e="radio"==a.inputType?N(d):C(d);var f=jQuery(d[0]).data("frmval");S(a.formId);jQuery.ajax({type:"POST",url:frm_js.ajax_url,data:{action:"frm_replace_cb_radio_lookup_options",parent_fields:a.parents,parent_vals:a.parentVals,field_id:a.fieldId,container_field_id:B(a),row_index:a.repeatRow,current_value:e,default_value:f,nonce:frm_js.nonce},success:function(e){c.innerHTML=e;e=b.getElementsByClassName("frm-loading-img")[0];null!==e&&void 0!==e&&e.parentNode.removeChild(e);
c.style.display="block";1==d.length&&""===d[0].value?sa(a,b):(!1!==v(b.id,a.formId)&&(e=K(a.fieldId),!1===e||1>e.conditions.length?(y(b.id,a.formId),jQuery("#"+b.id).show()):(e.containerId=b.id,e.repeatRow=a.repeatRow,ea(e))),void 0!==f&&(!1!==("radio"==a.inputType?N(d):C(d))||1>d.length||na(d[0].name,f)));r(jQuery(d[0]),a.fieldKey);va(jQuery(b));T(a.formId)}})}function va(a){a.trigger("frmLookupOptionsLoaded")}function sa(a,b){v(b.id,a.formId)||(jQuery("#"+b.id).hide(),qa(b.id,a.formId))}function ua(a,
b){if(D(b,a.formId))U(b.id);else if(!1===a.parentVals){var c=b.getAttribute("data-frmval");null===c&&(c="");xa(a,b,c);U(b.id)}else S(a.formId),jQuery.ajax({type:"POST",url:frm_js.ajax_url,data:{action:"frm_get_lookup_text_value",parent_fields:a.parents,parent_vals:a.parentVals,field_id:a.fieldId,nonce:frm_js.nonce},success:function(c){D(b,a.formId)||b.value==c||xa(a.fieldKey,b,c);T(a.formId);U(b.id)}})}function ta(a,b){var c=b.id;c in n?2<=n[c].length&&(n[c]=n[c].slice(0,1)):n[c]=[];n[c].push({childFieldArgs:a,
childInput:b})}function U(a){n[a].shift();a in n&&0<n[a].length&&ua(n[a][0].childFieldArgs,n[a][0].childInput)}function xa(a,b,c){c=c.replace(/&amp;/g,"&");b.value=c;r(jQuery(b),a)}function Xa(a,b){if(b){var c=jQuery("#"+a.containerId);ya(c)}jQuery.ajax({type:"POST",url:frm_js.ajax_url,data:{action:"frm_fields_ajax_get_data",entry_id:a.dataLogic.actualValue,current_field:a.fieldId,hide_id:a.containerId,on_current_page:b,nonce:frm_js.nonce},success:function(d){if(b){var e=c.find(".frm_opt_container, .frm_data_container");
e.html(d);var f=e.children("input"),g=f.val();za(e);""===d||""===g?L(a,!0):Aa(a,c,f,!0)}else e="field_"+a.fieldKey,""!==a.repeatRow&&(e+="-"+a.repeatRow),e=document.getElementById(e),e.value=d,v(a.containerId,a.formId)&&y(a.containerId,a.formId),r(jQuery(e))}})}function Ya(a,b){var c=jQuery("#"+a.containerId),d=c.find('select[name^="item_meta"], input[name^="item_meta"]'),e=Ba(d);d=d.data("frmval");var f=c.closest("form").find('input[name="id"]').val();ya(c);jQuery.ajax({type:"POST",url:frm_js.ajax_url,
data:{action:"frm_fields_ajax_data_options",trigger_field_id:a.dataLogic.fieldId,entry_id:a.dataLogic.actualValue,field_id:a.fieldId,default_value:d,container_id:a.containerId,editing_entry:f,prev_val:e,nonce:frm_js.nonce},success:function(b){var d=c.find(".frm_opt_container, .frm_data_container");d.html(b);var f=d.find('select, input[type="checkbox"], input[type="radio"]');za(d);""===b||1>f.length?L(a,!0):(b=Ba(f),Aa(a,c,f,e!==b))}})}function ya(a){var b=a.html();-1<b.indexOf("frm-loading-img")||
(a.html(b+'<span class="frm-loading-img"></span>'),a.find(".frm_opt_container, .frm_data_container").hide())}function db(a,b){if(!(-1<a.innerHTML.indexOf("frm-loading-img"))){b.style.display="none";var c=document.createElement("span");c.setAttribute("class","frm-loading-img");a.insertBefore(c,b.nextSibling)}}function za(a){a.parent().children(".frm-loading-img").remove();a.show()}function Ba(a){var b=[],c="";a.each(function(){c=this.value;"radio"===this.type||"checkbox"===this.type?!0===this.checked&&
b.push(c):""!==c&&b.push(c)});0===b.length&&(b="");return b}function Aa(a,b,c,d){v(a.containerId,a.formId)&&(y(a.containerId,a.formId),b.show());c.hasClass("frm_chzn")&&V();!0===d&&r(c)}function J(a,b){if("undefined"!==typeof __FRMCALC){var c=__FRMCALC,d=c.fields[a];if("undefined"!==typeof d){d=d.total;for(var e=d.length,f=[],g=eb(c.calc[d[0]]),h=0;h<e;h++){var k=g;if("undefined"!==typeof k.start||"undefined"!==typeof k.end){var l=jQuery('input[type=hidden][name*="['+c.calc[d[h]].field_id+']"]');
if(l.length)if(l.closest(".frm_form_field").length)l=!0;else{var m=l.index(),p=!0,q=!0;"undefined"!==typeof k.start&&(p=jQuery(k.start).index()<m);"undefined"!==typeof k.end&&(q=jQuery(k.end).index()>m);(k=p&&q)||(k=0<l.closest(".do-calculation").length);l=k}else l=!0}else l=!0;l&&(l=c.calc[d[h]],q=b.attr("name"),k=!1,m=l.field_id,p=z(l.form_id),1>p.length||("0"===l.inSection&&"0"===l.inEmbedForm?k=G(m,p):(q=w(q),G(m,p)?k=!0:Ca(m,q,p)?k=!0:"0"!==l.inSection&&"0"!==l.inEmbedForm?k=Ca(l.inSection,q,
p):"0"!==l.inSection?k=G(l.inSection,p):"0"!==l.inEmbedForm&&(k=G(l.inEmbedForm,p)))),l=k,l=!1===l);l&&Q(c,d[h],f,b)}}}}function eb(a){var b=a.form_id,c=document.getElementById("frm_form_"+b+"_container");if(null===c&&a.in_section){b=document.getElementById("frm_field_"+a.in_section+"_container");if(null===b)return[];c=Da(b,function(a){return"FORM"===a.tagName});b=c.elements.namedItem("form_id").value}a=c.getElementsByClassName("frm_next_page");b=document.getElementById("frm_page_order_"+b);c=[];
0<a.length&&(c.start=a[0]);null!==b&&(c.end=b);return c}function Da(a,b){return a&&(b(a)?a:Da(a.parentNode,b))}function G(a,b){return-1<b.indexOf("frm_field_"+a+"_container")}function Ca(a,b,c){var d=!1;b.repeatingSection&&(a="frm_field_"+a+"-"+b.repeatingSection,a+="-"+b.repeatRow+"_container",d=-1<c.indexOf(a));return d}function fb(a,b,c){var d="";jQuery("form").hasClass("frm-admin-viewing")&&(d+=frm_js.calc_error+" "+b+":\n\n",d+=c+"\n\n",a.message&&(d+=a.message+"\n\n"),alert(d))}function Q(a,
b,c,d){var e=a.calc[b],f=e.calc,g=jQuery(document.getElementById("field_"+b)),h={triggerField:d,inSection:!1,thisFieldCall:'input[id^="field_'+b+'-"]'};1>g.length&&"undefined"!==typeof d&&(h.inSection=!0,h.thisFieldId=gb(a.fieldsWithCalc,b),g=Ea(h));if(!(null===g||1>g.length)){f=hb(e,f,a,c,h);a="";if("text"==e.calc_type)a=f;else{e=e.calc_dec;-1<f.indexOf(").toFixed(")&&(c=f.split(").toFixed("),Fa(c[1])&&(e=c[1],f=f.replace(").toFixed("+e,"")));f=ib(f);try{a=parseFloat(eval(f))}catch(k){fb(k,b,f)}if("undefined"===
typeof a||isNaN(a))a=0;Fa(e)&&(a=a.toFixed(e))}g.val()!==a&&(g.val(a),null!==d&&"undefined"!==typeof d&&g.attr("name")==d.attr("name")||r(g,b))}}function hb(a,b,c,d,e){for(var f=0,g=a.fields.length;f<g;f++){var h={triggerField:e.triggerField,thisFieldId:a.fields[f],inSection:e.inSection,valKey:e.inSection+""+a.fields[f],thisField:c.fields[a.fields[f]],thisFieldCall:"input"+c.fieldKeys[a.fields[f]]},k=c;"checkbox"==h.thisField.type||"radio"==h.thisField.type||"scale"==h.thisField.type||"star"==h.thisField.type?
h.thisFieldCall=h.thisFieldCall+":checked,"+h.thisFieldCall+"[type=hidden]":"select"==h.thisField.type||"time"==h.thisField.type?h.thisFieldCall="select"+k.fieldKeys[h.thisFieldId]+" option:selected,"+h.thisFieldCall+"[type=hidden]":"textarea"==h.thisField.type&&(h.thisFieldCall=h.thisFieldCall+",textarea"+k.fieldKeys[h.thisFieldId]);if("text"==a.calc_type)h.valKey="text"+h.valKey,d=jb(h,d),"undefined"===typeof d[h.valKey]&&(d[h.valKey]="");else{h.valKey="num"+h.valKey;d=kb(h,c,d);if("undefined"===
typeof d[h.valKey]||isNaN(d[h.valKey]))d[h.valKey]=0;"date"==h.thisField.type&&0===d[h.valKey]&&(b="")}k="["+h.thisFieldId+"]";k=k.replace(/([.*+?^=!:${}()|\[\]\/\\])/g,"\\$1");b=b.replace(new RegExp(k,"g"),d[h.valKey])}return b}function ib(a){var b=a.charAt(a.length-1);if("+"===b||"-"===b)a=a.substr(0,a.length-1);return a}function A(a){return 3<=a.split("][").length}function kb(a,b,c){if("undefined"!==typeof c[a.valKey]&&0!==c[a.valKey])return c;c[a.valKey]=0;var d=Ga(a);if(!1===d)return c;d.each(function(){var d=
Ha(a.thisField,this);if("date"==a.thisField.type){var f=b.date;var g=0;if(d)if("undefined"===typeof jQuery.datepicker){g="-";-1<f.indexOf("/")&&(g="/");f=f.split(g);d=d.split(g);var h;var k=g=h="";for(var l=0;l<f.length;l++)if("y"==f[l])k=((new Date).getFullYear()+15).toString().substr(2,2),k=d[l]>k?"19"+d[l]:"20"+d[l];else if("yy"==f[l])k=d[l];else if("m"==f[l]||"mm"==f[l])g=d[l],2>g.length&&(g="0"+g);else if("d"==f[l]||"dd"==f[l])h=d[l],2>h.length&&(h="0"+h);g=Date.parse(k+"-"+g+"-"+h)}else g=jQuery.datepicker.parseDate(f,
...
""!==c.repeatRow){if(c=b.length?b.find(d):jQuery(d),null===c||"undefined"===typeof c||1>c.length)c=null,d.indexOf(":checked")?1>b.find(d.replace(":checked","")).length&&(c=jQuery(a.thisFieldCall)):c=jQuery(a.thisFieldCall)}else c=jQuery(a.thisFieldCall);return c}function Ha(a,b){var c=!1;if("hidden"==b.type)""!==W(b)&&(c=!0);else if("select"==a.type){var d=b.className;d&&-1<d.indexOf("frm_other_trigger")&&(c=!0)}else("checkbox"==a.type||"radio"==a.type)&&-1<b.id.indexOf("-other_")&&0>b.id.indexOf("-otext")&&
(c=!0);c?(c=0,"select"==a.type?"hidden"==b.type?(d=!1,2<b.name.split("[").length&&(d=!0),d||(c=W(b))):c=jQuery(b).closest(".frm_other_container").find(".frm_other_input").val():"checkbox"!=a.type&&"radio"!=a.type||"hidden"==b.type||(c=W(b))):c="checkbox"===b.type||"radio"===b.type?b.checked?b.value:b.dataset.off:jQuery(b).val();"undefined"===typeof c&&(c="");return c}function W(a){var b="";a=document.getElementById(a.id+"-otext");null!==a&&""!==a.value&&(b=a.value);return b}function lb(a,b){X("pageLoad");
var c=jQuery(b).find('input[name="id"]');c.length&&(c=document.getElementById("frm_edit_"+c.val()),null!==c&&-1<c.className.indexOf("frm_cancel_edit")&&Ia(jQuery(c)));H()}function mb(){H()}function nb(a,b){google.load("visualization","1.0",{packages:[b],callback:function(){var b=new google.visualization.DataTable,d=!1;-1!==jQuery.inArray("id",a.options.fields)&&(d=!0,b.addColumn("number",frm_js.id));for(var e=a.fields.length,f,g=0,h=e;g<h;g++){var k=a.fields[g];f=Ja(k);b.addColumn(f,k.name)}g=!1;
a.options.edit_link&&(g=!0,b.addColumn("string",a.options.edit_link));h=!1;a.options.delete_link&&(h=!0,b.addColumn("string",a.options.delete_link));if(null!==a.entries){var l=a.entries.length;b.addRows(l);for(var m=0,p=0;p<l;p++){k=0;var q=a.entries[p];d&&(b.setCell(m,k,q.id),k++);for(var n=0,r=e;n<r;n++){var t=a.fields[n];f=Ja(t);t=q.metas[t.id];"number"!=f||null!==t&&""!==t?"boolean"==f&&(t=null===t||"false"==t||!1===t?!1:!0):t=0;b.setCell(m,k,t);k++}g&&("undefined"!==typeof q.editLink?b.setCell(m,
k,'<a href="'+q.editLink+'">'+a.options.edit_link+"</a>"):b.setCell(m,k,""),k++);h&&("undefined"!==typeof q.deleteLink?b.setCell(m,k,'<a href="'+q.deleteLink+'" class="frm_delete_link" data-frmconfirm="'+a.options.confirm+'">'+a.options.delete_link+"</a>"):b.setCell(m,k,""));m++}}else for(b.addRows(1),g=k=0,h=e;g<h;g++)0<k?b.setCell(0,k,""):b.setCell(0,k,a.options.no_entries),k++;(new google.visualization.Table(document.getElementById("frm_google_table_"+a.options.form_id))).draw(b,a.graphOpts)}})}
function ob(a){google.load("visualization","1.0",{packages:[a["package"]],callback:function(){new google.visualization.DataTable;var b=google.visualization.arrayToDataTable(a.data);var c=document.getElementById("chart_"+a.graph_id);if(null!==c){var d=a.type.charAt(0).toUpperCase()+a.type.slice(1);"Histogram"!==d&&"Table"!==d&&(d+="Chart");c=new google.visualization[d](c);c.draw(b,a.options);jQuery(document).trigger("frmDrawChart",[c,"chart_"+a.graph_id,b])}}})}function Ja(a){var b="string";if("number"==
a.type)b="number";else if("checkbox"==a.type||"select"==a.type){var c=a.options.length;"select"==a.type&&""===a.options[0]&&(c="post_status"==a.field_options.post_field?3:c-1);1==c&&(b="boolean")}return b}function pb(){var a=jQuery(this).data("key"),b=jQuery(this).data("parent"),c="frm_section_"+b+"-"+a,d=jQuery(document.getElementById(c)),e=d.find("input, select, textarea"),f=jQuery(this).closest("form").find('input[name="form_id"]').val();d.fadeOut("slow",function(){d.remove();e.each(function(){var c=
...
a+":last").attr("id").replace("frm_section_"+a+"-","");b=-1<d.indexOf("i")?1:1+parseInt(d)}jQuery.ajax({type:"POST",url:frm_js.ajax_url,dataType:"json",data:{action:"frm_add_form_row",field_id:a,i:b,numberOfSections:c,nonce:frm_js.nonce},success:function(c){if(c.html){var d=c.html,e=jQuery(d).addClass("frm-fade-in");jQuery(".frm_repeat_"+a+":last").after(e);c.is_repeat_limit_reached&&jQuery("#frm_field_"+a+"_container .frm_add_form_row.frm_button").addClass("frm_hide_add_button");var h=["other"],
k,l,m={repeatingSection:a.toString(),repeatRow:b.toString()};jQuery(d).find("input, select, textarea").each(function(){if("file"!=this.type){if(""===this.name)return!0;k=this.name.replace("item_meta[","").split("]")[2].replace("[","");-1==jQuery.inArray(k,h)&&!1!==this.id&&""!==this.id&&(l=jQuery("#"+this.id),h.push(k),x(k,m),R(k,m,"value changed"),ba(k,l),ca(k,l,"value changed"),J(k,l))}});jQuery(d).find(".frm_html_container").each(function(){var a=this.id.replace("frm_field_","").split("-")[0];
h.push(a);x(a,m)});Z(m.repeatRow);Ka();V()}"function"==typeof frmThemeOverride_frmAddRow&&frmThemeOverride_frmAddRow(a,c);jQuery(document).trigger("frmAfterAddRow");I=!1},error:function(){I=!1}});return!1}function rb(){var a=jQuery(this),b=a.data("entryid"),c=a.data("prefix"),d=a.data("pageid"),e=a.data("formid"),f=a.data("cancel"),g=a.data("fields"),h=a.data("excludefields"),k=jQuery(document.getElementById(c+b)),l=k.html();k.html('<span class="frm-loading-img" id="'+c+b+'"></span><div class="frm_orig_content" style="display:none">'+
l+"</div>");jQuery.ajax({type:"POST",url:frm_js.ajax_url,dataType:"html",data:{action:"frm_entries_edit_entry_ajax",post_id:d,entry_id:b,id:e,nonce:frm_js.nonce,fields:g,exclude_fields:h},success:function(d){k.children(".frm-loading-img").replaceWith(d);a.removeClass("frm_inplace_edit").addClass("frm_cancel_edit");a.html(f);X("editInPlace");if("function"===typeof frmFrontForm.fieldValueChanged)jQuery(document).on("change",'.frm-show-form input[name^="item_meta"], .frm-show-form select[name^="item_meta"], .frm-show-form textarea[name^="item_meta"]',
frmFrontForm.fieldValueChanged);H(c+b)}});return!1}function sb(){var a=jQuery(this),b=a.data("prefix"),c=a.data("entryid");b=jQuery(document.getElementById(b+c));b.children(".frm_forms").replaceWith("");b.children(".frm_orig_content").fadeIn("slow").removeClass("frm_orig_content");Ia(a)}function Ia(a){var b=a.data("edit");a.removeClass("frm_cancel_edit").addClass("frm_inplace_edit");a.html(b)}function tb(){var a=jQuery(this),b=a.data("deleteconfirm");if(confirm(b)){var c=a.data("entryid"),d=a.data("prefix");
...
(c=" star-rating-on"),""!==c&&(b[d].className+=c))}function Ka(){jQuery(document).on("input","input[data-frmrange]",function(){var a=jQuery(this);a.next(".frm_range_value").html(a.val())})}function yb(){var a,b=jQuery(".frm_inline_form .frm_fields_container");if(b.length)for(a=0;a<b.length;a++){var c=jQuery(b[a]);var d=c.children(".frm_form_field");if(12>=d.length&&!Ma(d.last())){var e=d;var f=Math.max(2,Math.ceil(12/(e.length+1)));for(d=0;d<e.length;d++)Ma(jQuery(e[d]))||jQuery(e[d]).addClass("frm"+
f);c.children(".frm_submit").addClass("frm"+f)}}}function Ma(a){var b,c=a.attr("class"),d="frm_full half third fourth fifth sixth seventh eighth".split(" ");for(b=1;12>=b;b++){if(a.hasClass("frm"+b))return!0;if(12===b)for(var e=0;e<d.length;e++){if(c.includes(d[e]))return!0;if(e===d.length-1)return!1}}}function X(a){"undefined"!==typeof __frmHideOrShowFields?frmProForm.hideOrShowFields(__frmHideOrShowFields,a):Na()}function Na(){jQuery(".frm_pro_form").fadeIn("slow")}function r(a,b){"undefined"===
typeof b&&(b="dependent");1<a.length&&(a=a.eq(0));a.trigger({type:"change",selfTriggered:!0,frmTriggered:b})}function w(a){var b={repeatingSection:"",repeatRow:""};"undefined"!==typeof a&&A(a)&&(a=a.split("]["),b.repeatingSection=a[0].replace("item_meta[",""),b.repeatRow=a[1]);return b}function Sa(a){a.fadeOut("slow",function(){a.remove()})}function gb(a,b){for(var c in a)if(a.hasOwnProperty(c)&&a[c]===b)return c;return null}function Fa(a){return!jQuery.isArray(a)&&0<=a-parseFloat(a)+1}var I=!1,Wa=
"",u=0,n={};return{init:function(){jQuery(document).on("frmFormComplete",lb);jQuery(document).on("frmPageChanged",mb);jQuery(document).on("click",".frm_trigger",Oa);var a=jQuery(".frm_blank_field");a.length&&a.closest(".frm_toggle_container").prev(".frm_trigger").click();jQuery(document).on("click",".frm_remove_link",Ra);jQuery(document).on("focusin","input[data-frmmask]",function(){jQuery(this).mask(jQuery(this).data("frmmask").toString(),{autoclear:!1})});jQuery(document).on("frmFieldChanged",Ua);
jQuery(document).on("mouseenter click",".frm-star-group input",vb);jQuery(document).on("mouseenter",".frm-star-group .star-rating:not(.star-rating-readonly)",wb);jQuery(document).on("mouseleave",".frm-star-group .star-rating:not(.star-rating-readonly)",xb);jQuery(document).on("click",'.frm-show-form input[type="submit"], .frm-show-form input[name="frm_prev_page"], .frm_page_back, .frm_page_skip, .frm-show-form .frm_save_draft, .frm_prev_page, .frm_button_submit',Y);jQuery(document).on("change",'.frm_other_container input[type="checkbox"], .frm_other_container input[type="radio"], .frm_other_container select',
Ta);jQuery(document).on("click",".frm_remove_form_row",pb);jQuery(document).on("click",".frm_add_form_row",qb);jQuery(".frm_edit_link_container").on("click","a.frm_inplace_edit",rb);jQuery(".frm_edit_link_container").on("click","a.frm_cancel_edit",sb);jQuery(document).on("click",".frm_ajax_delete",tb);jQuery(".frm_month_heading, .frm_year_heading").click(function(){var a=jQuery(this).children(".ui-icon-triangle-1-e, .ui-icon-triangle-1-s");a.hasClass("ui-icon-triangle-1-e")?(a.addClass("ui-icon-triangle-1-s").removeClass("ui-icon-triangle-1-e"),
jQuery(this).next(".frm_toggle_container").fadeIn("slow")):(a.addClass("ui-icon-triangle-1-e").removeClass("ui-icon-triangle-1-s"),jQuery(this).next(".frm_toggle_container").hide())});yb();X("pageLoad");H()},savingDraft:function(a){var b=!1;a=jQuery(a).find(".frm_saving_draft");a.length&&(b=a.val());return b},goingToPreviousPage:function(a){var b=!1,c=jQuery(a).find(".frm_next_page");if(c.length&&c.val()){var d=jQuery(a).find('input[name="form_id"]').val();a=jQuery(a).find('input[name="frm_page_order_'+
d+'"]');a=a.length?a.val():0;if(!a||c.val()<a)b=!0}return b},hideOrShowFields:function(a,b){if("pageLoad"===b){var c=document.querySelectorAll('[id^="frm_hide_fields_"]');F(c)}c={repeatingSection:"",repeatRow:""};for(var d=0,e=a.length;d<e;d++)x(a[d],c),d==e-1&&Na()},hidePreviouslyHiddenFields:function(){var a=[];for(var b=document.querySelectorAll('*[id^="frm_hide_fields_"]'),c=b.length,d,e=0;e<c;e++)d=b[e].id.replace("frm_hide_fields_",""),a=a.concat(z(d));b=0;for(c=a.length;b<c;b++)d=document.getElementById(a[b]),
null!==d&&(d.style.display="none")},checkDependentDynamicFields:function(a){for(var b={repeatingSection:"",repeatRow:""},c=0,d=a.length;c<d;c++)x(a[c],b)},checkDependentLookupFields:function(a){for(var b,c={repeatingSection:"",repeatRow:""},d=0,e=a.length;d<e;d++)b=a[d],R(b,c,"value changed")},loadGoogle:function(){if("undefined"!==typeof google&&google&&google.load)for(var a=__FRMTABLES,b=Object.keys(a),c=0;c<b.length;c++)if("graphs"===b[c])for(var d=a[b[c]],e=0,f=d.length;e<f;e++)ob(d[e]);else for(d=
a[b[c]],e=b[c],f=0;f<d.length;f++)nb(d[f],e);else setTimeout(frmFrontForm.loadGoogle,30)},removeUsedTimes:function(a,b){var c=jQuery(a).parents("form:first").find('input[name="id"]');jQuery.ajax({type:"POST",url:frm_js.ajax_url,dataType:"json",data:{action:"frm_fields_ajax_time_options",time_field:b,date_field:a.id,entry_id:c?c.val():"",date:jQuery(a).val(),nonce:frm_js.nonce},success:function(a){var c=jQuery(document.getElementById(b));c.find("option").removeAttr("disabled");if(0<a.length)for(var d=
0,g=a.length;d<g;d++)c.find('option[value="'+a[d]+'"]').attr("disabled","disabled")}})}}}var frmProForm=frmProFormJS();jQuery(document).ready(function(Y){frmProForm.init()});