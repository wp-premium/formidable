<tr>
	<td><?php esc_html_e( 'Placeholder text', 'formidable-pro' ); ?>
		<span class="frm_help frm_icon_font frm_tooltip_icon" title="<?php esc_attr_e( 'Set the placeholder text for your Lookup field.', 'formidable-pro' ) ?>"></span>
	</td>
    <td>
...
<tr id="frm_multiple_cont_<?php echo esc_attr( $field['id'] ) ?>" <?php echo ( $field['data_type'] != 'select' ) ? ' class="frm_hidden"' : ''; ?>>
	<td><?php esc_html_e( 'Autocomplete', 'formidable-pro' ) ?></td>
	<td>
		<label for="autocom_<?php echo esc_attr( $field['id'] ) ?>">
			...
			<?php esc_html_e( 'enable autocomplete', 'formidable-pro' ) ?>
		</label>
	</td>
</tr>
