<div id="frm_watch_lookup_<?php echo esc_attr( $field_id .'_'. $row_key ) ?>">
	...
	<a href="javascript:void(0)" class="frm_remove_tag frm_icon_font" data-removeid="frm_watch_lookup_<?php echo esc_attr( $field_id .'_' . $row_key ) ?>" data-fieldid="<?php echo esc_attr( $field_id ) ?>"></a>
