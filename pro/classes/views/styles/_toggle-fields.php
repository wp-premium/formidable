...
<div class="field-group clearfix frm-first-row">
	<label for="frm_progress_bg_color"><?php esc_html_e( 'On Color', 'formidable-pro' ); ?></label>
...
<div class="field-group clearfix frm-first-row">
	<label for="frm_progress_color"><?php esc_html_e( 'Off Color', 'formidable-pro' ); ?></label>
