...
<div class="field-group field-group-border clearfix frm-first-row">
	<label for="frm_progress_bg_color"><?php _e( 'BG Color', 'formidable-pro' ) ?></label>
...
<div class="field-group clearfix frm-first-row">
	<label for="frm_progress_color"><?php _e( 'Text Color', 'formidable-pro' ) ?></label>
...
<div class="field-group clearfix field-group-border">
	<label for="frm_progress_active_bg_color_color"><?php _e( 'Active BG', 'formidable-pro' ) ?></label>
...
<div class="field-group clearfix">
	<label for="frm_progress_active_color"><?php _e( 'Active Text', 'formidable-pro' ) ?></label>
...
<div class="field-group field-group-border clearfix">
	<label for="frm_progress_border_color"><?php _e( 'Border Color', 'formidable-pro' ) ?></label>
...
<div class="field-group clearfix">
	<label for="frm_progress_border_size"><?php _e( 'Border Size', 'formidable-pro' ) ?></label>
...
<div class="field-group clearfix">
	<label for="frm_progress_size"><?php _e( 'Circle Size', 'formidable-pro' ) ?></label>
