<div class="posttypediv">
	<ul class="posttype-tabs add-menu-item-tabs">
		<li <?php echo ( 'default' == $current_tab ? ' class="tabs"' : '' ); ?>>
    		<a href="<?php echo esc_url('?page=formidable-styles&page-tab=default#tabs-panel-headings') ?>" class="nav-tab-link" data-type="tabs-panel-headings" ><?php _e( 'Headings', 'formidable-pro' ) ?></a>
    	</li>
		<li <?php echo ( 'collapse' == $current_tab ? ' class="tabs"' : '' ); ?>>
			<a href="<?php echo esc_url('?page=formidable-styles&page-tab=collapse#page-collapse') ?>" class="nav-tab-link" data-type="tabs-panel-collapse" ><?php _e( 'Collapsible', 'formidable-pro' ) ?></a>
		</li>
		<li <?php echo ( 'repeat' == $current_tab ? ' class="tabs"' : '' ); ?>>
			<a href="?page=formidable-styles&page-tab=repeat#tabs-panel-repeat" class="nav-tab-link" data-type="tabs-panel-repeat"><?php _e( 'Repeatable', 'formidable-pro' ) ?></a>
		</li>
	</ul><!-- .posttype-tabs -->
	...
	?>">
	    <div class="field-group field-group-background">
        	<label><?php _e( 'Color', 'formidable-pro' ) ?></label>
        ...
        <div class="field-group">
        	<label><?php _e( 'Weight', 'formidable-pro' ) ?></label>
        ...
        <div class="field-group">
        	<label><?php _e( 'Size', 'formidable-pro' ) ?></label>
        ...
        <div class="field-group field-group-border frm-half">
        	<label><?php _e( 'Padding', 'formidable-pro' ) ?></label>
        ...
        <div class="field-group frm-half">
    	    <label class="background"><?php _e( 'BG color', 'formidable-pro' ) ?></label>
        ...
        <div class="field-group field-group-border frm-half">
        	<label><?php _e( 'Top Margin', 'formidable-pro' ) ?></label>
        ...
        <div class="field-group frm-half">
        	<label><?php _e( 'Bottom Margin', 'formidable-pro' ) ?></label>
        ...
        <div class="field-group field-group-border">
            <label><?php _e( 'Border', 'formidable-pro' ) ?></label>
        ...
        <div class="field-group">
        	<label><?php _e( 'Thickness', 'formidable-pro' ) ?></label>
        ...
        <div class="field-group">
        	<label><?php _e( 'Style', 'formidable-pro' ) ?></label>
        	<select name="<?php echo esc_attr( $frm_style->get_field_name('section_border_style') ) ?>" id="frm_section_border_style">
        	    <option value="solid" <?php selected($style->post_content['section_border_style'], 'solid') ?>><?php _e( 'solid', 'formidable-pro' ) ?></option>
        		<option value="dotted" <?php selected($style->post_content['section_border_style'], 'dotted') ?>><?php _e( 'dotted', 'formidable-pro' ) ?></option>
        		<option value="dashed" <?php selected($style->post_content['section_border_style'], 'dashed') ?>><?php _e( 'dashed', 'formidable-pro' ) ?></option>
        		<option value="double" <?php selected($style->post_content['section_border_style'], 'double') ?>><?php _e( 'double', 'formidable-pro' ) ?></option>
        	</select>
        </div>

        <div class="field-group field-group-border frm-half">
        	<label><?php _e( 'Border Position', 'formidable-pro' ) ?></label>
        	<select name="<?php echo esc_attr( $frm_style->get_field_name('section_border_loc') ) ?>" id="frm_section_border_loc">
        	    <option value="-top" <?php selected($style->post_content['section_border_loc'], '-top') ?>><?php _e( 'top', 'formidable-pro' ) ?></option>
        		<option value="-bottom" <?php selected($style->post_content['section_border_loc'], '-bottom') ?>><?php _e( 'bottom', 'formidable-pro' ) ?></option>
        		<option value="-left" <?php selected($style->post_content['section_border_loc'], '-left') ?>><?php _e( 'left', 'formidable-pro' ) ?></option>
        		<option value="-right" <?php selected($style->post_content['section_border_loc'], '-right') ?>><?php _e( 'right', 'formidable-pro' ) ?></option>
        		<option value="" <?php selected($style->post_content['section_border_loc'], '') ?>><?php _e( 'all', 'formidable-pro' ) ?></option>
        	</select>
        </div>
        <div class="clear"></div>
	</div><!-- /.tabs-panel -->
	...
	?>">
	    <div class="field-group frm-half">
        	<label><?php _e( 'Icons', 'formidable-pro' ) ?></label>
            <?php FrmStylesHelper::bs_icon_select($style, $frm_style, 'arrow'); ?>
        </div>

        <div class="field-group frm-half">
        	<label><?php _e( 'Icon Position', 'formidable-pro' ) ?></label>
        	<select name="<?php echo esc_attr( $frm_style->get_field_name('collapse_pos') ) ?>" id="frm_collapse_pos">
        	    <option value="after" <?php selected($style->post_content['collapse_pos'], 'after') ?>><?php _e( 'After Heading', 'formidable-pro' ) ?></option>
        	    <option value="before" <?php selected($style->post_content['collapse_pos'], 'before') ?>><?php _e( 'Before Heading', 'formidable-pro' ) ?></option>
        	</select>
        </div>
        <div class="clear"></div>
	</div><!-- /.tabs-panel -->
