...
<div class="wrap">
    <h2 class="nav-tab-wrapper">
    	<a href="#frm_content_box" class="nav-tab nav-tab-active" id="frm_listing_tab" data-one="<?php esc_attr_e( 'Detail Page', 'formidable-pro' ); ?>" data-label="<?php esc_attr_e( 'Listing Page', 'formidable-pro' ); ?>"><?php echo ( $post->frm_show_count == 'one' ) ? esc_html__( 'Detail Page', 'formidable-pro' ) : esc_html__( 'Listing Page', 'formidable-pro' ); ?></a>
    	<a href="#frm_dyncontent_box" class="nav-tab hide_dyncontent <?php echo esc_attr( $use_dynamic_content ? '' : 'frm_hidden' ); ?>"><?php esc_html_e( 'Detail Page', 'formidable-pro' ); ?></a>
