<tr>
	<td><label><?php _e( 'Visibility', 'formidable-pro' ) ?></label>
	...
	<td>
		...
		<select name="field_options[admin_only_<?php echo absint( $field['id'] ) ?>]">
			<option value=""><?php _e( 'Everyone', 'formidable-pro' ) ?></option>
			<?php FrmAppHelper::roles_options($field['admin_only']); ?>
			<option value="loggedin" <?php selected($field['admin_only'], 'loggedin') ?>><?php _e( 'Logged-in Users', 'formidable-pro' ) ?></option>
			<option value="loggedout" <?php selected($field['admin_only'], 'loggedout') ?>><?php _e( 'Logged-out Users', 'formidable-pro' ); ?></option>
		</select>
	</td>
</tr>
